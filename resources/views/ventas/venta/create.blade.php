			...
			<div class="panel-body">
				...
				<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
					...
					<div class="form-group">
						...
						<select name="pidarticulo" class="form-control " id="pidarticulo" >
							...
							<option value="{{$articulo->stock}}"></option>
							<option value=" {{$articulo->precio_promedio}}"></option>
							@endforeach
				...
				<div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
					...
					<div class="form-group">
						...
						<input type="number"  id="pprecio_venta" class="form-control" placeholder="Precio de Venta">
					</div>
				...
				<div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
					...
					<div class="form-group">
						<label for="Precio de Compra">Descuento</label>
